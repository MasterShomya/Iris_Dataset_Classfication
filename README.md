...
This repository contains a many different models for classifying the Iris dataset. The model predicts the species of an Iris flower based on its petal & sepal measurements.
